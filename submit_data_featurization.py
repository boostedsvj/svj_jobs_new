...
#years = ['Run2018A-UL2018-v1', ]
#bkg_prefixs = ['QCD_Pt', 'TTJets_', 'WJetsToLNu_', 'ZJetsToNuNu_']
data_prefixs = ['JetHT']

#/store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV20/Run2018A-UL2018-v1/JetHT/996_RA2AnalysisTree.root
#/store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV20/Summer20UL18/QCD_Pt_300to470_TuneCP5_13TeV_pythia8/930_RA2AnalysisTree.root
#root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Run2ProductionV20/Summer20UL18/QCD_Pt_300to470_TuneCP5_13TeV_pythia8/930_RA2AnalysisTree.root
...
def main():
    ...
    group.sh('pip install -U --no-cache-dir https://github.com/boostedsvj/svj_ntuple_processing/archive/control_region.zip')
    #group.sh('pip install https://github.com/boostedsvj/svj_ntuple_processing/archive/control_region.zip')
